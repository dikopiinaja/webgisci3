				...
				<form method="post" action="<?= site_url('admin/tambahJadwal')?>">
					<div class="row">
						<div class="form-group col-md-4">
							...
							<select name="mobil"
								class="form-control <?php echo form_error('mobil') ? 'is-invalid':'' ?>">
						...
						<div class="form-group col-md-3">
							...
							<select name="asal"
								class="form-control  <?php echo form_error('asal') ? 'is-invalid':'' ?>">
						...
						<div class="form-group col-md-4">
							...
							<select name="tujuan"
								class="form-control  <?php echo form_error('tujuan') ? 'is-invalid':'' ?>">
