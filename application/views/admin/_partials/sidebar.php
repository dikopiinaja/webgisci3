<ul class="navbar-nav bg-gradient-dark sidebar sidebar-blue accordion" id="accordionSidebar">
	...
	<li class="nav-item">
		...
		<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item <?php if($this->uri->segment(1)=='admin/perjalanan'){echo 'active';}?>" href="<?= base_url('admin/perjalanan');?>">Perjalanan</a>
				<a class="collapse-item <?php if($this->uri->segment(1)=='jadwal'){echo 'active';}?>" href="<?= base_url('admin/jadwal');?>">Jadwal Keberangkatan</a>
				<a class="collapse-item <?php if($this->uri->segment(1)=='supir'){echo 'active';}?>" href="<?= base_url('admin/supir');?>">Supir</a>
				<a class="collapse-item <?php if($this->uri->segment(1)=='mobil'){echo 'active';}?>" href="<?= base_url('admin/mobil');?>">Mobil</a>
				<a class="collapse-item <?php if($this->uri->segment(1)=='kategori'){echo 'active';}?>" href="<?= base_url('admin/kategori');?>">Kategori</a>
			</div>
		</div>
	</li>
	...
	<!-- Nav Item - Pages Collapse Menu -->
	<li class="nav-item  <?php if($this->uri->segment(1)=='admin/daftarPenumpang'){echo 'active';}?>">
	...
	<li class="nav-item">
		<a class="nav-link <?php if($this->uri->segment(1)=='supir'){echo 'active';}?>" href="<?= site_url('supir');?>">
			<i class="fas fa-fw fa-home"></i>
			<span>Dashboard</span>
		</a>
	</li>
	...
	<li class="nav-item <?php if($this->uri->segment(1)=='daftarPenumpang'){echo 'active';}?>">
