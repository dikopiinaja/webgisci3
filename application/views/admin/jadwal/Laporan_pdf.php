...
<body>
	<div class="card">
		<div class="card-body">
			<h3 style="text-align:center;"><i>Jadwal Keberangkatan</i></h3>
			<h2 style="text-align:center;">New Mutiara Travel</h2>
			...
			<table class="table table-sm table-hover">
				...
				<tr>
					...
					<td><?= tanggal_indo(date('Y-m-d',strtotime($j->tgl_berangkat))); ?> - <?= tanggal_indo(date('Y-m-d',strtotime($j->tgl_sampai))); ?></td>
				</tr>
				</tr>
				<?php endforeach ?>
			</table>
